...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreIntance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        Appname,
        TEXT("MY Perspective Graphics with Trangle !"),
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:
        switch (wParam)
        {
            //0
        case 48:
            glViewport(0, 0, (GLsizei)rc.right, (GLsizei)rc.bottom);
            break;
            //1
        case 49:
            glViewport(0, (GLsizei)rc.bottom / 2, (GLsizei)rc.right / 2, (GLsizei)rc.bottom / 2);
            break;
            //2
        case 50:
            glViewport((GLsizei)rc.right / 2, (GLsizei)rc.bottom / 2, (GLsizei)rc.right / 2, (GLsizei)rc.bottom / 2);
            break;
            //3
        case 51:
            glViewport((GLsizei)rc.right / 2, 0, (GLsizei)rc.right / 2, (GLsizei)rc.bottom / 2);
            break;
            //4
        case 52:
            glViewport(0, 0, (GLsizei)rc.right / 2, (GLsizei)rc.bottom / 2);
            break;
            //5
        case 53:
            glViewport(0, 0, (GLsizei)rc.right / 2, rc.bottom);
            break;
            //6
        case 54:
            glViewport((GLsizei)rc.right / 2, 0, (GLsizei)rc.right / 2, rc.bottom);
            break;
            //7
        case 55:
            glViewport(0, (GLsizei)rc.bottom / 2, rc.right, (GLsizei)rc.bottom / 2);
            break;
            //8
        case 56:
            glViewport(0, 0, rc.right, (GLsizei)rc.bottom / 2);
            break;
            //9
        case 57:
            glViewport((GLsizei)rc.right / 4, (GLsizei)rc.bottom / 4, (GLsizei)rc.right / 2, (GLsizei)rc.bottom / 2);
            break;
